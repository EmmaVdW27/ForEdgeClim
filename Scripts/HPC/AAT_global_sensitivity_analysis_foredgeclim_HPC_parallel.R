...
print(paste("Using", availableCores(), "cores for parallel processing."))

SOBOL_plot_file = '/user/gent/465/vsc46574/ForEdgeClim_on_HPC/Output/sensitivity_analysis/global_sensitivity_analysis_SOBOL_indices_parallel.pdf'
SA_output_file = "/user/gent/465/vsc46574/ForEdgeClim_on_HPC/Output/sensitivity_analysis/sobol_design_results.rds"
...
# for n = 400 and cores = 50 and n_boot = 1000: 2h
...
print("start SOBOL sensitivity analysis")
...
saveRDS(sobol_design, file = SA_output_file)
...
print("Start plotting and saving results")
...
ggsave(SOBOL_plot_file, plot = sobol_indices, width = 6, height = 9, dpi = 300)
