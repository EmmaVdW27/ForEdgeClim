...
SOBOL_plot_file = 'Output/sensitivity_analysis/global_sensitivity_analysis_SOBOL_indices_parallel.png'
SA_output_file = "Output/sensitivity_analysis/sobol_design_results.rds"

start_analysis = Sys.time()

datetime = as.POSIXct("2023-07-08 12:00:00", tz = "UTC")

n = 5 # no of samples. Ideal around 250/500
...
# for n = 5 and cores = 10 and nboot = 1000: 6.18 min
