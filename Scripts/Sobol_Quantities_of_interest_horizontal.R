...
output_plot_normalized <- "Sobol_QoI_horizontal_normalized.png"
output_plot_unnormalized <- "Sobol_QoI_horizontal_unnormalized.png"

output_plot_focused_normalized <- "Sobol_QoI_focused_horizontal_normalized.png"
output_plot_focused_unnormalized <- "Sobol_QoI_focused_horizontal_unnormalized.png"

output_plot_parameters_by_condition_normalized <- "Sobol_parameter_by_condition_horizontal_normalized.png"
output_plot_parameters_by_condition_unnormalized <- "Sobol_parameter_by_condition_horizontal_unnormalized.png"

output_plot_focused_parameters_by_condition_normalized <- "Sobol_focused_parameter_by_condition_horizontal_normalized.png"
output_plot_focused_parameters_by_condition_unnormalized <- "Sobol_focused_parameter_by_condition_horizontal_unnormalized.png"
...
files_info <- tribble(
  ...
  # winter files
    # night
  "400samples_25parameters_01h_13012025_avT_h.rds",     "Wi_Ni_≈T",
  "400samples_25parameters_01h_13012025_SDT_h.rds",     "Wi_Ni_σT",
  "400samples_25parameters_01h_13012025_gradT_h.rds",   "Wi_Ni_∇T",
    # morning
  "400samples_25parameters_08h_13012025_avT_h.rds",     "Wi_Mo_≈T",
  "400samples_25parameters_08h_13012025_SDT_h.rds",     "Wi_Mo_σT",
  "400samples_25parameters_08h_13012025_gradT_h.rds",   "Wi_Mo_∇T",
    # noon
  "400samples_25parameters_12h_13012025_avT_h.rds",     "Wi_No_≈T",
  "400samples_25parameters_12h_13012025_SDT_h.rds",     "Wi_No_σT",
  "400samples_25parameters_12h_13012025_gradT_h.rds",   "Wi_No_∇T",
  # spring
    # night
  "400samples_25parameters_01h_30042025_avT_h.rds",     "Sp_Ni_≈T",
  "400samples_25parameters_01h_30042025_SDT_h.rds",     "Sp_Ni_σT",
  "400samples_25parameters_01h_30042025_gradT_h.rds",   "Sp_Ni_∇T",
    # morning
  "400samples_25parameters_05h_30042025_avT_h.rds",     "Sp_Mo_≈T",
  "400samples_25parameters_05h_30042025_SDT_h.rds",     "Sp_Mo_σT",
  "400samples_25parameters_05h_30042025_gradT_h.rds",   "Sp_Mo_∇T",
    # noon
  "400samples_25parameters_12h_30042025_avT_h.rds",     "Sp_No_≈T",
  "400samples_25parameters_12h_30042025_SDT_h.rds",     "Sp_No_σT",
  "400samples_25parameters_12h_30042025_gradT_h.rds",   "Sp_No_∇T",
  # summer
    # night
  "400samples_25parameters_01h_07072023_avT_h.rds",     "Su_Ni_≈T",
  "400samples_25parameters_01h_07072023_SDT_h.rds",     "Su_Ni_σT",
  "400samples_25parameters_01h_07072023_gradT_h.rds",   "Su_Ni_∇T",
    # morning
  "400samples_25parameters_05h_07072023_avT_h.rds",     "Su_Mo_≈T",
  "400samples_25parameters_05h_07072023_SDT_h.rds",     "Su_Mo_σT",
  "400samples_25parameters_05h_07072023_gradT_h.rds",   "Su_Mo_∇T",
    # noon
  "400samples_25parameters_12h_07072023_avT_h.rds",     "Su_No_≈T",
  "400samples_25parameters_12h_07072023_SDT_h.rds",     "Su_No_σT",
  "400samples_25parameters_12h_07072023_gradT_h.rds",   "Su_No_∇T",
  # autumn files
    # night
  "400samples_25parameters_01h_01102023_avT_h.rds",     "Au_Ni_≈T",
  "400samples_25parameters_01h_01102023_SDT_h.rds",     "Au_Ni_σT",
  "400samples_25parameters_01h_01102023_gradT_h.rds",   "Au_Ni_∇T",
    # morning
  "400samples_25parameters_06h_01102023_avT_h.rds",     "Au_Mo_≈T",
  "400samples_25parameters_06h_01102023_SDT_h.rds",     "Au_Mo_σT",
  "400samples_25parameters_06h_01102023_gradT_h.rds",   "Au_Mo_∇T",
    # noon
  "400samples_25parameters_12h_01102023_avT_h.rds",     "Au_No_≈T",
  "400samples_25parameters_12h_01102023_SDT_h.rds",     "Au_No_σT",
  "400samples_25parameters_12h_01102023_gradT_h.rds",   "Au_No_∇T"
...
p_n = ggplot(sobol_df, aes(x = norm_value, y = label, fill = parameter)) +
  geom_col(width = 0.5) +
  labs(
    title = "Parameter contribution to QoI variance along the horizontal line",
...
p_focus_n <- ggplot(sobol_focus_df, aes(x = norm_value, y = label, fill = parameter)) +
  geom_col(width = 0.5) +
  labs(
    title = "Key parameter contribution to QoI variance along the horizontal line",
    x = "Normalised total-order Sobol-index",
    y = "QoI",
    fill = "Parameter",
    caption = "QoI = Quantity of Interest\nSp = spring | Su = summer | Au = autumn | Wi = winter\nMo = morning | No = noon | Ni = night\n≈T = average temperature | σT = standard deviation on temperature | ∇T = temperature gradient"
...
p_condition_n <- ggplot(mean_combined_n, aes(x = mean_index, y = condition, fill = parameter)) +
  ...
  scale_fill_manual(values = param_colors) +
  labs(
    title = "Parameter contribution to condition variance along the horizontal line",
...
p_condition_focused_n <- ggplot(mean_combined_focused_n, aes(x = mean_index, y = condition, fill = parameter)) +
  ...
  scale_fill_manual(values = focus_colors) +
  labs(
    title = "Key parameter contribution to condition variance along the horizontal line",
    x = "Average normalised total-order Sobol-index",
    y = "Condition",
    fill = "Parameter",
    caption = "Sp = spring | Su = summer | Au = autumn | Wi = winter\nMo = morning | No = noon | Ni = night\n≈T = average temperature | σT = standard deviation on temperature | ∇T = temperature gradient"
